...
public class Bvruaajm_SqlBvr extends Bmouaajm_SQL{
    ...
    /**  Esse Metodo efetua a Inserção de um dado na tabela Transacao de um Link Pago  **/
    ...
    /**  Esse Metodo efetua a Atualização do link pgto na tabela Link_Pagamento  **/
    ...
    /**  Esse Metodo efetua a Atualização do link pgto Para uma data uma mantendo o status atual  **/
